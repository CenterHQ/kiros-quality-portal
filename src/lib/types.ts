...
export const CONTEXT_TYPE_COLORS: Record<CentreContextType, { bg: string; text: string }> = {
  ...
  policy_requirement: { bg: '#edf8fc', text: '#0369a1' },
  procedure_step: { bg: '#edf7ed', text: '#15803d' },
  service_value: { bg: '#f3e8fa', text: '#470DA8' },
  teaching_approach: { bg: '#edf8fc', text: '#0055cc' },
  family_engagement: { bg: '#e8f5ee', text: '#047857' },
  inclusion_practice: { bg: '#fef8ec', text: '#e67e22' },
  safety_protocol: { bg: '#fdf0f0', text: '#e74c3c' },
  environment_feature: { bg: '#edf7ed', text: '#15803d' },
