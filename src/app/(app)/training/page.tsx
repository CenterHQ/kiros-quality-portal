              ...
              <div className="px-6 py-4 border-b border-gray-100">
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-lg bg-[#6b2fa0] flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                      {idx + 1}
                    </div>
                    <div>
                    ...
                    {assigningModuleId === mod.id ? (
                      <div className="space-y-2">
                        <select
                          ...
                          className="w-full px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#6b2fa0] focus:border-transparent outline-none"
                        >
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 bg-[#6b2fa0] text-white text-xs rounded-lg hover:bg-[#5a2788] transition font-medium"
                          >
                            Assign
                          </button>
                          <button
                      ...
                      <button
                        ...
                        className="text-xs text-[#6b2fa0] hover:text-[#5a2788] font-medium transition"
                      >
                        + Assign to User
                      </button>
                    )}
