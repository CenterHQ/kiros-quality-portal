                  ...
                  {areaResources.map(res => (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <h3 className="text-sm font-semibold text-gray-900 group-hover:text-[#6b2fa0] transition">
                          {res.title}
                        </h3>
                        <svg
                          className="w-4 h-4 text-gray-300 group-hover:text-[#6b2fa0] transition flex-shrink-0 mt-0.5 ml-2"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
